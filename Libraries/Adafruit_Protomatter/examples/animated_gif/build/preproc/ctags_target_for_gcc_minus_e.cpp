# 1 "D:\\Documents\\Arduino\\libraries\\Adafruit_Protomatter\\examples\\animated_gif\\animated_gif.ino"
...
# 18 "D:\\Documents\\Arduino\\libraries\\Adafruit_Protomatter\\examples\\animated_gif\\animated_gif.ino" 2

# 20 "D:\\Documents\\Arduino\\libraries\\Adafruit_Protomatter\\examples\\animated_gif\\animated_gif.ino" 2
# 21 "D:\\Documents\\Arduino\\libraries\\Adafruit_Protomatter\\examples\\animated_gif\\animated_gif.ino" 2

# 23 "D:\\Documents\\Arduino\\libraries\\Adafruit_Protomatter\\examples\\animated_gif\\animated_gif.ino" 2

// CONFIGURABLE SETTINGS ---------------------------------------------------

char GIFpath[] = "/32x32GIF"; // Absolute path to GIFs on CIRCUITPY drive
...
Adafruit_Protomatter matrix(64 /* Matrix width in pixels*/, 6, 1, rgbPins, 4, addrPins,
...
void *GIFOpenFile(char *filename, int32_t *pSize) {
  ...
  return 
# 70 "D:\\Documents\\Arduino\\libraries\\Adafruit_Protomatter\\examples\\animated_gif\\animated_gif.ino" 3 4
        __null
# 70 "D:\\Documents\\Arduino\\libraries\\Adafruit_Protomatter\\examples\\animated_gif\\animated_gif.ino"
            ;
}
...
int16_t numFiles(const char *path, const char *filter) {
  ...
  for(int16_t num_files = 0;;) {
    ...
    entry.name(filename, sizeof(filename) - 1);
    entry.close();
...
char *filenameByIndex(const char *path, const char *filter, int16_t index) {
  ...
  File entry, dir = SD.open(path);
  if (!dir) return 
# 231 "D:\\Documents\\Arduino\\libraries\\Adafruit_Protomatter\\examples\\animated_gif\\animated_gif.ino" 3 4
                  __null
# 231 "D:\\Documents\\Arduino\\libraries\\Adafruit_Protomatter\\examples\\animated_gif\\animated_gif.ino"
                      ;
  ...
  return 
# 245 "D:\\Documents\\Arduino\\libraries\\Adafruit_Protomatter\\examples\\animated_gif\\animated_gif.ino" 3 4
        __null
# 245 "D:\\Documents\\Arduino\\libraries\\Adafruit_Protomatter\\examples\\animated_gif\\animated_gif.ino"
            ;
}
...
void setup() {
  ...
  // usb_msc.begin();
  // SD.begin(&flash); // Start filesystem on the flash
...
# 334 "D:\\Documents\\Arduino\\libraries\\Adafruit_Protomatter\\examples\\animated_gif\\animated_gif.ino"
  if (GIFincrement) { // Change file?
    ...
    if (GIF.playFrame(true, 
# 362 "D:\\Documents\\Arduino\\libraries\\Adafruit_Protomatter\\examples\\animated_gif\\animated_gif.ino" 3 4
                           __null
# 362 "D:\\Documents\\Arduino\\libraries\\Adafruit_Protomatter\\examples\\animated_gif\\animated_gif.ino"
                               ) >= 0) { // Auto resets to start if needed
      matrix.show();
