...
void TetrisMatrixDraw::setBrightness(bool b){
  if(b){
    ...
    this->tetrisRED = 0x8800;
    this->tetrisGREEN = 0x03e1;
    this->tetrisBLUE = 0x08ed;
    this->tetrisWHITE = 0x8888;
    this->tetrisYELLOW = 0x8440;
    this->tetrisCYAN = 0x03ce;
    this->tetrisMAGENTA = 0x780e;
    this->tetrisORANGE = 0x79c0;
    this->tetrisBLACK = 0x0000;
  }
}
